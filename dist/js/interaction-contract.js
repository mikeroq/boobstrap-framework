...
export const interactionContract = Object.freeze({
  ...
  navbar: { core: { controller: "Navbar", initializer: "initNavbars", methods: ["show", "hide", "toggle", "destroy"] }, adapters: adapter("navbar", "useNavbar", "useNavbar"), capabilities: ["responsive-overlay", "focus-trap", "escape-dismiss", "selection-dismiss"], events: ["bs:navbar:show", "bs:navbar:shown", "bs:navbar:hide", "bs:navbar:hidden"] },
