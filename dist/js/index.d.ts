...
export class Combobox extends ElementController { constructor(element: HTMLElement, options?: { multiple?: boolean }); static getOrCreateInstance(element: HTMLElement, options?: { multiple?: boolean }): Combobox; readonly expanded: boolean; readonly multiple: boolean; readonly options: HTMLElement[]; readonly visibleOptions: HTMLElement[]; readonly selectedOptions: HTMLElement[]; show(): boolean; hide(options?: { force?: boolean }): boolean; toggle(): boolean; select(option: HTMLElement, options?: { sourceEvent?: Event }): boolean; reset(): void; }
export function initComboboxes(root?: Root): Combobox[];
export interface CommandPaletteOptions { shortcut?: string; }
export class CommandPalette extends ElementController { constructor(element: HTMLElement, options?: CommandPaletteOptions); static getOrCreateInstance(element: HTMLElement, options?: CommandPaletteOptions): CommandPalette; readonly visible: boolean; search(query: string, sourceEvent?: Event): void; select(item: HTMLElement, sourceEvent?: Event): boolean; show(options?: FocusTransitionOptions): boolean; hide(options?: FocusTransitionOptions): boolean; toggle(options?: FocusTransitionOptions): boolean; }
export function initCommandPalettes(root?: Root): CommandPalette[];
