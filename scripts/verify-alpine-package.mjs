...
import boobstrap, { accordion, banner, button, collapse, combobox, dialog, dropdown, inputMask, navbar, otp, password, popover, sidebar, tabs, toast, tooltip } from "@boobstrap/alpine";
...
assert.deepEqual([...providers.keys()], ["bsAccordion", "bsBanner", "bsButton", "bsCollapse", "bsCombobox", "bsDropdown", "bsDialog", "bsInputMask", "bsNavbar", "bsOtp", "bsPassword", "bsPopover", "bsSidebar", "bsTabs", "bsToast", "bsTooltip"]);
...
console.log(`Verified @boobstrap/alpine package contents and sixteen registered data providers (${pack.size} byte tarball).`);
