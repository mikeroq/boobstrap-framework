...
import boobstrap, { button, collapse, combobox, dialog, dropdown, tabs } from "@boobstrap/alpine";
...
assert.deepEqual([...providers.keys()], ["bsButton", "bsCollapse", "bsCombobox", "bsDropdown", "bsDialog", "bsTabs"]);
...
console.log(`Verified @boobstrap/alpine package contents and six registered data providers (${pack.size} byte tarball).`);
