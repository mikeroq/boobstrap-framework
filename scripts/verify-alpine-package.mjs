...
assert.deepEqual([...providers.keys()], ["bsButton", "bsCollapse", "bsCombobox", "bsDropdown", "bsDialog", "bsPopover", "bsTabs", "bsToast", "bsTooltip"]);
...
console.log(`Verified @boobstrap/alpine package contents and nine registered data providers (${pack.size} byte tarball).`);
