...
const requiredPaths = [
  "LICENSE", "README.md", "package.json", "src/button.js", "src/collapse.js", "src/combobox.js", "src/dialog.js",
...
for (const hook of [useButton, useCollapse, useCombobox, useDialog, useDropdown, usePopover, useTabs, useToast, useTooltip]) assert.equal(typeof hook, "function");
...
console.log(`Verified @boobstrap/vue package contents, nine composable exports, type declarations, and SSR-safe rendering (${pack.size} byte tarball).`);
