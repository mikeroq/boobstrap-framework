...
const requiredPaths = [
  ...
  "src/dropdown.js", "src/index.d.ts", "src/index.js", "src/navbar.js", "src/popover.js", "src/shared.js", "src/tabs.js", "src/toast.js", "src/tooltip.js",
];
assert.deepEqual(requiredPaths.filter((path) => !paths.includes(path)), [], "Vue package is missing required files");
for (const hook of [useAccordion, useButton, useCollapse, useCombobox, useDialog, useDropdown, useNavbar, usePopover, useTabs, useToast, useTooltip]) assert.equal(typeof hook, "function");
...
console.log(`Verified @boobstrap/vue package contents, eleven composable exports, type declarations, and SSR-safe rendering (${pack.size} byte tarball).`);
